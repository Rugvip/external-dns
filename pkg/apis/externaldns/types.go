...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("default-target", "Default target to use if no target annotation or load balancer IP is available; specify multiple times for multiple targets (optional)").StringsVar(&cfg.DefaultTargets)
